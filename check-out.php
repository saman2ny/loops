...
$custRow = $query->fetch_assoc();  ?>
						...
						<div class="row">
							...
							<div class="col-xs-6 hidden">
								<label>Itemid <sup>*</sup></label>
								<input type="text" class="input-text" name="trueitemId" id="trueitemId"  disabled>
							</div>
...
$custRow = $query->fetch_assoc();  ?>
							...
							<div class="col-xs-12">
								<label>Email Address <sup>*</sup></label>
								<input type="text" class="input-text" name="custemail" id="custemail" value="<?php echo $custRow['email']; ?>"disabled>
							</div>
							<div class="col-xs-12">
								<label>Address <sup>*</sup></label>
                        ...
                        <div class="col-xs-6">
								...
								<input type="text" class="input-text" name="random" id="random" value="LF1236" disabled>
							</div>
...
$custRow = $query->fetch_assoc();  ?>
					       ...
					       <div class="col-xs-6">
							...
							<div class="col-xs-6">
								<label>Random <sup>*</sup></label>
								<input type="text" class="input-text" name="random" id="random" value="LF1235" disabled>
							</div>
		...
		<div class="summa row hidden" >
                ...
                if($cart->total_items() > 0){
                    ...
                    foreach($cartItems as $item){
                        ...
                        $total_shipping = "60";
                          $foo = $total_Capital + $total_shipping;
                          $qty += $item["qty"];
                            $itemId .=$item["id"];
                ...
                ?>
				 <?php } } ?>
							<div class="col-xs-6">
								<label>ItemId <sup>*</sup></label>
								<input type="text" class="input-text" name="dupitemId" id="dupitemId" value="<?php echo $itemId; ?>" disabled>
							</div>		
                            
                            <div class="col-xs-6">
								<label>Price <sup>*</sup></label>
								<input type="text" class="input-text" name="dupvalue" id="dupvalue" value="<?php echo $foo; ?>" disabled>
							</div>
							
											
							<div class="col-xs-6">
								<label>Qtny <sup>*</sup></label>
								<input type="text" class="input-text" name="dupqnty" id="dupqnty" value="<?php echo $qty; ?>" disabled>
							</div>
...
$itemId = $("#dupitemId").val();
$('input[name=trueitemId]').val($itemId);
$value = $("#dupvalue").val();
